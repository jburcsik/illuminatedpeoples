...
function writeImg(){
    ...
    console.log('** The COunter is: ' + k);
        ...
        $(".img-feed-c").append("<div class='entry'><a rel='img-group' title='" + htmlEntities(imgList[i].user) + (imgList[i].message != "" ? ": " : "") + htmlEntities(imgList[i].message) + "' href='" + imgList[i].imgSource + "' class='fancy-img'></a>" + titleTxt + "<img style='" + imgStyle + "' class='" + imgClass + "' src='" + imgList[i].imgSource + "' alt='' onerror='imgError(this)' />" + metaTxt + "</div>");
        // currImg++;
    //}
